...
const Edit = ({
  ...
  }, images.map(img => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    key: img.id,
    src: img.url,
    alt: img.alt
  })))));
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkbloque_toeatin"] = self["webpackChunkbloque_toeatin"] || [];
